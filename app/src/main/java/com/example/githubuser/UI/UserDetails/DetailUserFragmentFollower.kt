 ...
 */
class DetailUserFragmentFollower : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_detail_user_fragment_follower, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvItem = view.findViewById(R.id.rv_item_follower)
...
//                progressBar.visibility = View.INVISIBLE
    ...
    companion object {
        ...
        fun newInstance(username: String): DetailUserFragmentFollower {
            val fragment = DetailUserFragmentFollower()
            val bundle = Bundle()
