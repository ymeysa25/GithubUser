...
import com.example.githubuser.data.db.DatabaseContract.UserColumns.Companion.USERNAME
import com.example.githubuser.data.db.DatabaseContract.UserColumns.Companion._ID
...
class UserHelper(context: Context) {
    ...
    fun deletebByUsername(username: String): Int{
